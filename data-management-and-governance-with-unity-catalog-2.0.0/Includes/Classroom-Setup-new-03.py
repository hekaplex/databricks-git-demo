...
spark.sql(f"DROP SCHEMA IF EXISTS {clean_username} CASCADE;")
spark.sql(f"CREATE SCHEMA {clean_username};")
spark.sql(f"USE SCHEMA {clean_username};")

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE movies
# MAGIC (
# MAGIC   _c0 STRING,
# MAGIC   title STRING,
# MAGIC   year STRING,
...
# MAGIC );
# MAGIC
# MAGIC INSERT INTO movies VALUES
