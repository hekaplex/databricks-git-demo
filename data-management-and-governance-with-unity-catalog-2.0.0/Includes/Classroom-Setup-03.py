...
# MAGIC %sql
# MAGIC CREATE SCHEMA IF NOT EXISTS hive_metastore.example;
# MAGIC CREATE OR REPLACE TABLE hive_metastore.example.movies
# MAGIC (
# MAGIC   _c0 STRING,
# MAGIC   title STRING,
# MAGIC   year STRING,
...
# MAGIC );
# MAGIC
# MAGIC INSERT INTO hive_metastore.example.movies VALUES
...
external_delta_table = f'dbfs:///FileStore/tables/example'
...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS hive_metastore.example.test_external;
# MAGIC CREATE TABLE hive_metastore.example.test_external
